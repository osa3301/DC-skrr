...
bool c_config::init( ) {
	...
	item( g_vars.rage.autowall, "g_vars.rage.autowall", m_items );
	...
	item( g_vars.rage.resolver_enabled, "g_vars.rage.resolver_enabled", m_items );
	...
	item( g_vars.misc.vm_aimbot, "g_vars.misc.vm_aimbot", m_items );
	item( g_vars.misc.tick_base_manipulation_rapidfire_enabled, "g_vars.misc.tick_base_manipulation_rapidfire_enabled", m_items );
	item( g_vars.misc.tick_base_manipulation_rapidfire_key, "g_vars.misc.tick_base_manipulation_rapidfire_key", m_items );
