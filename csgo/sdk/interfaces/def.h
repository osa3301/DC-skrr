...
public:
	...
	uint32_t m_oldtickcount;            //0x4D18
	float m_tick_remainder;        //0x4D1C
	float m_frame_time;            //0x4D20
	uint32_t m_last_outgoing_command;    //0x4D24
	uint32_t m_choked_commands;        //0x4D28
	uint32_t m_last_command_ack;        //0x4D2C
	uint32_t m_command_ack;            //0x4D30
	uint32_t m_sound_sequence;            //0x4D34
	char pad8[0x50];                //0x4D38
	vec3_t viewangles;                //0x4D88
	char pad9[0xD0];                //0x4D9A
	uint32_t events;                    //0x4E6A
}; //Size: 0x4EAE
