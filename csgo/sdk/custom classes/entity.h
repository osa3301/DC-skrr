...
public:
	...
	bool is_weapon( ) {
		return util::misc::vfunc< bool(__thiscall*)( void * ) >( this, 165 )( this );
	}
...
public:
	...
	OFFSET( bool, in_reload, 0x3285 ) // 0x3285 => 0x3285
...
public:
	...
	NETVAR( int, viewmodel_handle, "DT_BasePlayer", "m_hViewModel[0]" )
	...
	OFFSET( c_utl_vector< matrix3x4_t >, bone_cache, 0x2910 ) // 0x2910 => 0x2924 m_flLastBoneSetupTime 
	OFFSET( int, eflags, 0x104 ) // 0xE8 => 0x104
	OFFSET( vec3_t, abs_velocity, 0x114 ) // 0x94 => 0x114
	OFFSET( int, get_bone_count, 0x291C) // 30.10.19 S= OK
	...
	c_base_player* get_viewmodel_handle() {
		return g_csgo.m_entity_list->get< c_base_player >( viewmodel_handle( ) );
	}
